...
public:
	...
	MCCPtr createMCC(Node *node, uint16_t contributedItemId, uint16_t contributed_quantity, uint16_t constraintItemId);

	MCPPtr createMCP(Node *node, uint16_t requestedItemId, uint16_t contributedItemId, unsigned int searchDepth);
	MCPPtr createMCP(Node *node, uint16_t requestedItemId, uint16_t requested_quantity, uint16_t contributedItemId, uint16_t contributed_quantity, uint16_t actual_amount_contribution,unsigned int searchDepth);

	UCCPtr createUCC(Node *node, uint16_t contributedItemId, uint16_t constraintItemId);
	UCCPtr createUCC(Node *node, uint16_t contributedItemId, uint16_t contributed_quantity, uint16_t constraintItemId);
	...
	UCPPtr createUCP(Node *node, uint16_t requestedItemId, uint16_t requested_quantity, uint16_t contributedItemId, uint16_t contributed_quantity, uint16_t actual_amount_contribution, const AgentLocation &uccLocation, unsigned int searchDepth);
