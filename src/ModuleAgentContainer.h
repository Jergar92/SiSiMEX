...
public:
	...
	MCPPtr createMCP(Node *node, uint16_t requestedItemId, uint16_t requested_quantity, uint16_t contributedItemId, uint16_t contributed_quantity, unsigned int searchDepth);
	...
	UCPPtr createUCP(Node *node, uint16_t requestedItemId, uint16_t requested_quantity, uint16_t contributedItemId, uint16_t contributed_quantity, const AgentLocation &uccLocation, unsigned int searchDepth);
